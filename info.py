...
PICS = (environ.get('PICS', 'https://telegra.ph/file/7332eedfcbc58a841c61a.jpg')).split()
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Professorr](https://t.me/Professorr_x)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>Thanks for using me</b>❤️\n🔥  ↭ <b>Join Now for [Terabox Movies](https://t.me/terabox_movies7)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @Professorr_x \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️Bella Ciao♥️ \n\n⚠️Click on the button 👇 below to get your query privately")
...
DOWNLOAD_TEXT_URL = "https://t.me/+PTanCTBATpo3YTg9"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://telegra.ph/Professorr-Botz-Update-12-19-2"
